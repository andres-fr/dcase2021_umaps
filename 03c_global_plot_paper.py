...
"""
Since they are smaller, the global plots used in the paper contain smaller
legend regions
"""
...
#
CONF.LEGEND_SHADOW_ALPHA = 0.6
CONF.LEGEND_DOT_EXTERNAL_RATIO = 1.3
CONF.LEGEND_TRAIN_RATIO = 1.3
CONF.LEGEND_TEST_SOURCE_RATIO = 0.9
CONF.LEGEND_TEST_TARGET_RATIO = 1.5
CONF.LEGEND_WIDTH_FACTOR = 0.3
CONF.LEGEND_FONT_SIZE = 34
CONF.LEGEND_ICON_SIZE = None
#
CONF.CUT_TOP = 0.06
CONF.CUT_BOTTOM = 0.08
CONF.CUT_LEFT = 0.135
CONF.CUT_RIGHT = 0.16
...
def plot_legend(ax, test_source_colordict, test_target_colordict,
    ...
    for lbl, colors in legend_train_source.items():
        ...
        ax_handles.append(MulticolorCircles(
            [colors[0]],
            radius_factor=CONF.LEGEND_TRAIN_RATIO,
            face_alpha=CONF.LEGEND_SHADOW_ALPHA))
...
fig.subplots_adjust(top=0.997, bottom=0.003, left=0.003, right=0.78, hspace=0,
                    wspace=0)
